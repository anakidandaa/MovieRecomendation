# -*- coding: utf-8 -*-
"""SistemRekomendasiFilms_Fayyaza8.ipynb
...
Setelah model collaborative filtering selesai dilatih, langkah selanjutnya adalah menghasilkan rekomendasi film berdasarkan pola kesukaan pengguna. Proses ini dilakukan dengan memilih salah satu pengguna secara acak, lalu sistem akan merekomendasikan film yang belum pernah ditonton (diberi rating) oleh pengguna tersebut, namun diprediksi akan disukai. Berikut tahapan untuk Generate Movie Recommendations
